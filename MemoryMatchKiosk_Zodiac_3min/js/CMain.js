function CMain(oData){
    ...
    this._loadImages = function(){
		...
		s_oSpriteLibrary.addSprite("but_resume","./sprites/but_resume.png");
		s_oSpriteLibrary.addSprite("but_quit","./sprites/but_quit.png");
        s_oSpriteLibrary.addSprite("bg_menu","./sprites/bg_menu.jpg");
		s_oSpriteLibrary.addSprite("bg_menu_logo","./sprites/bg_menu_logo.png");
		s_oSpriteLibrary.addSprite("bg_menu_header","./sprites/bg_menu_header.png");
