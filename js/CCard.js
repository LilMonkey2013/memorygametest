function CCard(iX,iY,iType,iCount,fScalingFactor,oContainer){
    ...
    this._init = function(iX,iY,iType,iCount,fScalingFactor,oContainer){
        _iX = iX;
        _iY = iY;
		_iCount = iCount;
        _bEliminated = false;
        ...
        _oSprite = createSprite(s_oGame.spriteSheet,"back1",CARD_WIDTH/2,CARD_HEIGHT/2,CARD_WIDTH,CARD_HEIGHT);
    ...
    this._init(iX,iY,iCount,iType,fScalingFactor,oContainer);      
}